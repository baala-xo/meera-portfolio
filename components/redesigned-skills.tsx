...
import { Download, Award, GraduationCap, Heart, ExternalLink } from "lucide-react"
import {
  Code,
  Cpu,
  Database,
...
const skillCategories = [
  ...
  {
    id: "programming",
    name: "Programming Basics (Java, Python)",
    icon: <Zap className="h-5 w-5" />,
    color: "from-purple-500 to-violet-500",
  },
  {
    id: "tools",
    name: "Design Tools (Photoshop, Canva, Paint 3D)",
    icon: <Tool className="h-5 w-5" />,
  ...
  return (
    <SectionContainer id="skills" className="bg-gradient-to-b from-background to-background/95">
      <SectionHeader
        ...
        subtitle="A comprehensive overview of my technical expertise across various domains."
      />

      <ScrollReveal>
      <StaggerItem>
              <div className="flex flex-wrap gap-3 mb-8 pl-30">
        ...
        <ScrollReveal>
          <p className="text-muted-foreground">
            These skills represent my technical expertise developed over years of Acadamic experience and continuous
            learning.
            <br />
