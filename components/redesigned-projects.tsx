...
export default function RedesignedProjects() {
    ...
    return (
      <SectionContainer id="projects" className="relative">
        <SectionHeader
          ...
          subtitle="Explore my portfolio of User Interface / User Experience projects."
        />
  ...
  return (
    <SectionContainer id="projects" className="relative">
      ...
      <SectionHeader
        title="Project Portfolio"
        subtitle="Explore my portfolio of User Interface / User Experience projects at Behance. Each project demonstrates my skills."
      />
  ...
  <Button
    ...
    onClick={() => window.open('https://www.behance.net/meeraarthisri')}
  >
    Visit
